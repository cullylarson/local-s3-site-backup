        ...
        return wait(backoff)
            ...
            .catch(err => {
                if(err.code === 'SlowDown') {
                    ...
                    logFn(logImportances.VERBOSE, 'Got SlowDown. ' + JSON.stringify({ numTried, numTries, backoff, backoffMs, backoffMaxMs }))
...
const listAllObjects = (s3, params, retryOptions = {}) => {
    return retryOnRateLimit(() => s3.listObjectsV2(params).promise(), retryOptions)
